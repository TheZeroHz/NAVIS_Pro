...
| **Laser Pointer**    | GPIO 2 (Strapping Pin- Should Set to HIGH for a normal boot) | Digital Output or PWM | Controls a laser pointer. If the laser requires >3.3V or high current, use a transistor (e.g., NPN or MOSFET) with a 1kΩ resistor to GPIO 2. Supports PWM for brightness control. |
...
| **Battety Monitor**  | GPIO 3 | Analog Input (Data) | Read the current battery voltage |
